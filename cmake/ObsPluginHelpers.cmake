...
if(OS_MACOS)
	...
	function(setup_plugin_target target)
		...
		if(NOT DEFINED MACOSX_PLUGIN_BUNDLE_NAME)
	...
	if(OS_POSIX)
		...
		if(OS_LINUX)
			...
			set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${PLUGIN_NAME}")
			set(CPACK_PACKAGE_HOMEPAGE_URL "${PLUGIN_URL}")
			...
			set(CPACK_DEBIAN_PACKAGE_CONFLICTS "obs-avs, obs-audio-video-sync-dock")
			set(CPACK_DEBIAN_PACKAGE_REPLACES "obs-avs, obs-audio-video-sync-dock")
